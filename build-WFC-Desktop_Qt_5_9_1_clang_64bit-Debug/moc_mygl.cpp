...
QT_MOC_LITERAL(1, 5, 19), // "wfcConvergenceError"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 22), // "wfcIterationInProgress"
QT_MOC_LITERAL(4, 49, 11) // "timerUpdate"

    },
    "MyGL\0wfcConvergenceError\0\0"
    "wfcIterationInProgress\0timerUpdate"
};
...
void MyGL::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->wfcConvergenceError((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->wfcIterationInProgress((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGL::wfcConvergenceError)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MyGL::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGL::wfcIterationInProgress)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyGL::wfcConvergenceError(bool _t1)
{
...
// SIGNAL 1
void MyGL::wfcIterationInProgress(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
